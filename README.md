...
[![Release](https://img.shields.io/badge/release-v1.7.12.0-blue)](https://github.com/kgillard/oom-watchdog/releases/tag/v1.7.12.0)

---

## Download

Pre-built JARs are available in the [v1.7.11.5 release](https://github.com/kgillard/oom-watchdog/releases/tag/v1.7.12.0):

| Artefact | Description | Size |
|----------|-------------|------|
| [`oom-watchdog.jar`](https://github.com/kgillard/oom-watchdog/releases/download/v1.7.12.0/oom-watchdog.jar) | Fat JAR — monitoring agent + CLI entry point | ~157 KB |
| [`test-harness.jar`](https://github.com/kgillard/oom-watchdog/releases/download/v1.7.12.0/test-harness.jar) | Fat JAR — interactive OOM test harness | ~171 KB |
...
curl -L -o oom-watchdog.jar \
  https://github.com/kgillard/oom-watchdog/releases/download/v1.7.12.0/oom-watchdog.jar
