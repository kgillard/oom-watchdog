...
[![Release](https://img.shields.io/badge/release-v1.7.13.28-blue)](https://github.com/kgillard/oom-watchdog/releases/tag/v1.7.13.28)

---

## Download

Pre-built JARs are available in the [v1.7.13.28 release](https://github.com/kgillard/oom-watchdog/releases/tag/v1.7.13.28):

| Artefact | Description | Size |
|----------|-------------|------|
| [`oom-watchdog.jar`](https://github.com/kgillard/oom-watchdog/releases/download/v1.7.13.28/oom-watchdog.jar) | Fat JAR — monitoring agent + CLI entry point | ~157 KB |
| [`test-harness.jar`](https://github.com/kgillard/oom-watchdog/releases/download/v1.7.13.28/test-harness.jar) | Fat JAR — interactive OOM test harness | ~171 KB |
...
curl -L -o oom-watchdog.jar \
  https://github.com/kgillard/oom-watchdog/releases/download/v1.7.13.28/oom-watchdog.jar
...
> **Same-host deployments (v1.7.13.28+):** When `--qradar-host` resolves to a local interface
