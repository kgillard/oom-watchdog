...
```
oom-watchdog/                  Maven multi-module root (v1.7.11.9)
...
The v1.7.11.9 release publishes two executable fat JARs built with `maven-shade-plugin`.
Both will be attached to the [GitHub release](https://github.com/kgillard/oom-watchdog/releases/tag/v1.7.11.9).
